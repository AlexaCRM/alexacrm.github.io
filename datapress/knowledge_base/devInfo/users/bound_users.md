...
tags:
    - Knowledge base
    - DataPress
description: PHP code example using the $wpdb class to query and display WordPress users with non-null 'icds_binding_ref' metadata, including details like last login, timezone, and locale. 
---
